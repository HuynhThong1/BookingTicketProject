      ...
      <div className="grid grid-cols-6">
        <div className="h-full p-3 space-y-2 col-span-1 dark:bg-coolGray-900 dark:text-coolGray-100">
          <div className="flex items-center p-2 space-x-4">
            <img
              src="https://vnn-imgs-f.vgcloud.vn/2020/11/27/16/nani-nhan-xet-cuc-chat-bruno-fernandes-mu-loi-to-1.jpg"
              alt="..."
              className="w-12 h-12 rounded-full"
            />
            <div>
              <h2 className="text-lg font-semibold">Bruno Fernandes</h2>
          ...
          <div className="divide-y divide-coolGray-700">
            <ul className="pt-2 pb-4 space-y-1 text-sm">
              {mangDanhMuc.map((danhMuc, index) => {
                ...
                const activeClass = ['dark:bg-coolGray-800', 'dark:text-coolGray-50', maDanhMuc === danhMuc.maDanhMuc ? 'bg-black text-white' : '']
                return (
                  <li
                    className={_.join(activeClass, ' ')}
                    key={index}
                    onClick={() => {
        ...
        <div className="col-span-5">
          <h3 className="text-center text-purple-500 text-4xl">Menu</h3>
                        ...
                        <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                          ...
                          <div className="p-6">
                            ...
                            <div className="flex items-center flex-wrap ">
                              <a href="#hehe" className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0 cursor-pointer" onClick={() => { 
                                    setOpenModal(true);
                                    setItem(item);
                                }}>
                                Chi Tiết
